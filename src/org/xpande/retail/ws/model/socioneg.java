 ...
 *
 */
@XmlRootElement(name = "socioneg")
public class socioneg implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6675005931625052602L;
	private int ID = 0;
	private String RUT = "";
	...
	public static socioneg getByRut(String RUT) throws Exception {

		socioneg partner = null;
